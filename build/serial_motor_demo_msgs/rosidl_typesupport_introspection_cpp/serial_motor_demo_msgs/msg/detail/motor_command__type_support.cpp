...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorCommand_message_member_array[4] = {
  {
    ...
    offsetof(serial_motor_demo_msgs::msg::MotorCommand, mot_1),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(serial_motor_demo_msgs::msg::MotorCommand, mot_2),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(serial_motor_demo_msgs::msg::MotorCommand, mot_3),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(serial_motor_demo_msgs::msg::MotorCommand, mot_4),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
