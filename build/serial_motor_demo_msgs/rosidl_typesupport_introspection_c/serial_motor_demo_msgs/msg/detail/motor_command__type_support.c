...
static rosidl_typesupport_introspection_c__MessageMember serial_motor_demo_msgs__msg__MotorCommand__rosidl_typesupport_introspection_c__MotorCommand_message_member_array[4] = {
  {
    "mot_1",  // name
    ...
    offsetof(serial_motor_demo_msgs__msg__MotorCommand, mot_1),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(serial_motor_demo_msgs__msg__MotorCommand, mot_2),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(serial_motor_demo_msgs__msg__MotorCommand, mot_3),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(serial_motor_demo_msgs__msg__MotorCommand, mot_4),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
